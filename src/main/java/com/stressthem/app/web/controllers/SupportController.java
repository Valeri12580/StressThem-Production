...
public class SupportController {
    ...
    @PostMapping("/contact")
    public String postContactForm(@ModelAttribute @Valid TicketBindingModel ticketBindingModel, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
    ...
    @GetMapping("/tickets/change-status/{id}/{status}")
    public String changeTicketStatus(@PathVariable String id, @PathVariable String status) {
        this.supportService.changeTicketStatus(id, status.equals("solved"));
